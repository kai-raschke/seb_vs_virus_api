...
let SysInfo = database.import(path.join('..', 'models', 'SysInfo.js'));
let Entry = database.import(path.join('..', 'models', 'Entry.js'));
let Group = database.import(path.join('..', 'models', 'Group.js'));
