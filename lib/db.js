...
let SysInfo = database.import(path.join(__dirname, '..', 'models', 'SysInfo.js'));
let Entry = database.import(path.join(__dirname, '..', 'models', 'Entry.js'));
let Group = database.import(path.join(__dirname, '..', 'models', 'Group.js'));
